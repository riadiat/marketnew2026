...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_seller_password'])) {
			$data['config_seller_password'] = $this->request->post['config_seller_password'];
		} else {
			$data['config_seller_password'] = $this->config->get('config_seller_password');
		}
