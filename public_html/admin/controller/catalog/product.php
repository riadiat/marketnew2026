...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$seller = $this->model_seller_user->getUser($result['seller_id']);
			$special = false;
	...
	protected function getForm() {
		...
		if (isset($this->request->post['seller'])) {
			...
			$manufacturer_info = $this->model_seller_user->getUser($product_info['seller_id']);

			if ($manufacturer_info) {
				$data['seller'] = $manufacturer_info['username'];
			} else {
				$data['seller'] = '';
			}
		} else {
	...
	protected function validateForm() {
        ...
        if (empty($this->request->post['seller_id']) || $this->request->post['seller_id'] =='0') {
