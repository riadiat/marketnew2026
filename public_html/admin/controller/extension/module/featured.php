...
class ControllerExtensionModuleFeatured extends Controller {
	...
	public function index() {
        ...
        } elseif (!empty($module_info) && isset($module_info['image_hover'])) {
        ...
        } elseif (!empty($module_info)  && isset($module_info['image']) && $module_info['image'] && is_file(DIR_IMAGE . $module_info['image'])) {
        ...
        } elseif (!empty($module_info) && isset($module_info['image_hover']) && $module_info['image_hover'] && is_file(DIR_IMAGE . $module_info['image_hover'])) {
            $data['thumb_hover'] = $this->model_tool_image->resize($module_info['image_hover'], 100, 100);
        } else {
