...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/videos')) {
                $catalog[] = array(
                    'name'	   => 'الفيديوهات',
                    'href'     => $this->url->link('catalog/videos', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'seller/user_permission')) {
                $seller[] = array(
                    'name'	   => 'مجموعات التجار',
                    'href'     => $this->url->link('seller/user_permission', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'seller/api')) {
                $seller[] = array(
                    'name'	   => $this->language->get('text_api'),
                    'href'     => $this->url->link('seller/api', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
