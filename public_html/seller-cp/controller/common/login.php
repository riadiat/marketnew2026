...
class ControllerCommonLogin extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->get['route'])&& $this->request->get['route'] !='seller/seller') {
		...
		if ($this->config->get('config_seller_password')) {
	...
	protected function validate() {
		...
		}elseif($this->seller->login($this->request->post['username'], html_entity_decode($this->request->post['password'], ENT_QUOTES, 'UTF-8')) && !$this->seller->getStatus()){
