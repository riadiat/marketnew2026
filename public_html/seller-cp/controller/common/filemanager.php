...
class ControllerCommonFileManager extends Controller {
	public function index() {
        ...
        if(!file_exists(DIR_IMAGE.'catalog/'.$this->seller->getUserName())){
            $directory = rtrim(DIR_IMAGE . 'catalog/' . $this->seller->getUserName(), '/');
        ...
        //$this->request->get['directory'] = $this->seller->getUserName();

        if (isset($this->request->get['directory'])) {
            $directory = rtrim(DIR_IMAGE . 'catalog/'.$this->seller->getUserName().'/' . str_replace('*', '', $this->request->get['directory']), '/');
        } else {
            $directory = DIR_IMAGE . 'catalog/'.$this->seller->getUserName();
        }
	...
	public function upload() {
		...
		// Make sure we have the correct directory
		if (isset($this->request->get['directory'])) {
			$directory = rtrim(DIR_IMAGE . 'catalog/'.$this->seller->getUserName() .'/' . $this->request->get['directory'], '/');
		} else {
			$directory = DIR_IMAGE . 'catalog';
		}
