...
$_['text_reviews']                            = '%s تعليق';
$_['text_write']                              = 'اضف تعليقك';
$_['text_login']                              = 'الرجاء <a href="%s">الدخول</a> أو <a href="%s">التسجيل</a> لكي تتمكن من تعليق المنتج';
$_['text_no_reviews']                         = 'لا يوجد أي تعليقات لهذا المنتج.';
$_['text_note']                               = '<span class="text-danger">انتبه: </span>لم يتم تفعيل اكواد HTML !';
$_['text_success']                            = 'شكرا لك على إضافة التعليق. سنقوم بمراجعة التعليق قريباً لاعتماده ';
