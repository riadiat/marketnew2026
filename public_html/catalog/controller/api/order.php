	...
	public function history() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($order_info) {
			    ...
			    if(isset($this->request->post['is_payment'])){
                    $this->model_checkout_order->addOrderHistorySeller($order_id, $this->request->post['order_status_id'], $this->request->post['comment'], $this->request->post['notify'], $this->request->post['override'],$this->request->post['s_id']);
                }else{
